...
class ClassConstructorFiller
{
    ...
    public function autowireParams(ReflectionMethod $constructor, $serviceId, Definition $definition, array $classes, array $forcedWires)
    {
        ...
        foreach ($constructor->getParameters() as $index => $parameter) {
            if (array_key_exists($index, $explicitlyDefinedArguments)) {
                ...
                $allArguments[] = $this->parameterProcessor->getParameterValue($parameter, $classes, $serviceId, $forcedWires);
            }
        }
